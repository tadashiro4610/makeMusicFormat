...
class songFormat:
    def __init__(self,master):
        ...
        def generate_event():
            ...
            m=makeSongFormat_app.msf(self.musicName,self.barLow,self.section_entry_list,self.bar_entry_list,self.col16_list,self.dir)
            m.wright()
        ...
        self.master.bind_all("<1>",callback)#複数のlabelを使用するため
